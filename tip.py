...
class TipCalulator():
    def __init__(self):
        ...
        tip_amount_lbl = Label(window,text="Tip Amount",bg="Black",fg="White")
        ...
        bill_total_lbl = Label(window,text="Bill Total",bg="Black",fg="white")
        ...
        clear_btn = Button(window,text="Clear",bg="Black",fg="White",command="")
